...
class TrainerConfig:
    ...
    # Logging
    log_every_n_steps: int = 10  # log training metrics every N optimizer steps
...
class PretrainConfig(TrainerConfig):
    ...
    Adds data paths, augmentation settings, loss choice, and optimizer
    hyper-parameters on top of the shared TrainerConfig.
    """
...
class FinetuneConfig(TrainerConfig):
    ...
    Extends TrainerConfig with data paths, class count, optional
